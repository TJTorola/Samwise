...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
  ...
  <title>New Invoice Recieved</title>
 ...
 <table border="0" cellpadding="0" cellspacing="0" width="100%">
	 ...
	 <tr style="background-color: #404040; color: white;">
	  <td style="padding:5px 5px 5px 5px; text-align: right;">
	   New Invoice Recieved
	  </td>
	 </tr>
	 <tr>
	  <td style="padding:5px 5px 5px 5px;">
		Hello, {{ $user->name }}<br>
	  We just recieved a new order at Pangolin 4x4, the full invoice is as follows.
	  </td>
	 </tr>
	 <tr>
		<td style="text-align: left; padding:5px 5px 5px 5px;">
			...
			{{ $invoice->street_address_second }}<br>
			@endif
			@if ($invoice->apt)
	 ...
	 <tr>
	 	<td style="padding:5px 5px 5px 5px; text-align: right;">
	 		<b>Subtotal: </b>{{ returnUSD($invoice->sub_total()) }}<br>
	 	</td>
	 </tr>
 </table>
</body>
