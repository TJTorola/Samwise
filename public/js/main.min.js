...
Vue.http.interceptors.push({
	...
	response: function response(_response) {
		...
		if (_response.status == 400) {
			this.notify('warning', 'Invalid Credentials', _response.data);
		}
...
module.exports = {
  ...
  deleteNotification: function deleteNotification(_ref7, id) {
...
var mutations = {
  ...
  PUSH_NOTIFICATION: function PUSH_NOTIFICATION(state, type, title, message) {
    var uid = 0;
  ...
  DELETE_NOTIFICATION: function DELETE_NOTIFICATION(state, id) {
