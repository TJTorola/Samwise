...
var mutations = {
	UPDATE_QUERY: function UPDATE_QUERY(state, query) {
		state.query = query;
	},

	CHANGE_PAGE: function CHANGE_PAGE(state, page) {
		state.page = page;
	},

	EXPAND_INDEX: function EXPAND_INDEX(state, index) {
		state.expandedIndex = index;
	},

	SET_SORT: function SET_SORT(state, key) {
