...
module.exports = {
	setEmail: function setEmail(_ref, e) {
		var dispatch = _ref.dispatch;
	...
	setSeperateBilling: function setSeperateBilling(_ref3, e) {
		var dispatch = _ref3.dispatch;
...
var mutations = {
	...
	SET_SHIPPING: function SET_SHIPPING(state, shipping_address) {
		state.shipping_address = shipping_address;
	},

	SET_BILLING: function SET_BILLING(state, billing_address) {
