...
},{"./vuex/actions.js":35,"./vuex/store.js":36,"vue":28,"vue-hot-reload-api":2}],32:[function(require,module,exports){
// libraries
'use strict';
...
},{"./app.vue":31,"./pages/inventory.vue":33,"./pages/login.vue":34,"vue":28,"vue-resource":16,"vue-router":27,"vuex":30}],33:[function(require,module,exports){
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
module.exports = {
  setEvents: function setEvents(_ref, count) {
    ...
    return dispatch('SET_EVENTS', count);
  },
  setMessages: function setMessages(_ref2, count) {
    var dispatch = _ref2.dispatch;
    return dispatch('SET_MESSAGES', count);
  },
  setInvoices: function setInvoices(_ref3, count) {
    var dispatch = _ref3.dispatch;
    return dispatch('SET_INVOICES', count);
  }
};
