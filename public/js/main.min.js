...
},{"./search/query.vue":57,"./table.vue":60,"vue":28,"vue-hot-reload-api":2}],54:[function(require,module,exports){
'use strict';
...
module.exports = {
	...
	watch: {
		maskedCount: function maskedCount() {
	...
	methods: {
		save: function save() {
			...
			this.$http.patch('invoice/' + this.invoice.id, request).then(function (response) {
				_this.$refs.save.check();
				_this.$dispatch('GET');
				_this.show = false;
			}, function () {
				_this.$refs.save.fail();
			});
		}
	}
};
