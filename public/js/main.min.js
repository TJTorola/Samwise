...
},{"./vuex/actions.js":34,"./vuex/store.js":35,"vue":28,"vue-hot-reload-api":2}],31:[function(require,module,exports){
// libraries
'use strict';
...
},{"./app.vue":30,"./pages/inventory.vue":32,"./pages/login.vue":33,"vue":28,"vue-resource":16,"vue-router":27,"vuex":29}],32:[function(require,module,exports){
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
module.exports = {
  methods: {
    login: function login() {
      this.$http.headers.common.Authorization = 'Bearer foo';
    }
  }
};
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<input type=\"button\" name=\"name\" value=\"Login\" @click=\"login\">\n"
