...
},{"./components/statusIcon.vue":31,"./vuex/actions.js":43,"./vuex/store.js":44,"vue":28,"vue-hot-reload-api":2}],31:[function(require,module,exports){
'use strict';
...
Vue.http.interceptors.push({
	response: function response(_response) {
		...
		if (_response.status == 200) {
			if (_response.request.url == "auth") {
				this.password = "";
				this.email = "";
				this.captchaRequired = false;
				Vue.http.headers.common['Authorization'] = 'Bearer ' + _response.data.token;
				this.login();
			}
		}
...
},{"./app.vue":30,"./pages/adminsettings.vue":33,"./pages/catalog.vue":34,"./pages/catalogs.vue":35,"./pages/inventory.vue":36,"./pages/invoice.vue":37,"./pages/invoices.vue":38,"./pages/item.vue":39,"./pages/newinvoice.vue":40,"./pages/pages.vue":41,"./pages/printinvoice.vue":42,"vue":28,"vue-resource":16,"vue-router":27,"vuex":29}],33:[function(require,module,exports){
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
module.exports = {
	...
	notify: function notify(_ref6, type, title, message, timeout) {
	...
	deleteNotification: function deleteNotification(_ref7, index) {
		var dispatch = _ref7.dispatch;

		dispatch('DELETE_NOTIFICATION', index);
	},

	setPage: function setPage(_ref8, name, description) {
