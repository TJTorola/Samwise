...
},{"./components/loginForm.vue":53,"./vuex/actions.js":71,"./vuex/store.js":86,"vue":43,"vue-hot-reload-api":17}],46:[function(require,module,exports){
'use strict';
...
module.exports = {
	...
	methods: {
		getItems: function getItems() {
			...
			if (this.sortSecond) {
				var sort = _Object$assign(this.sortToArray(this.sort), this.sortToArray(this.sortSecond));
			} else {
		...
		sortToArray: function sortToArray(sort) {
	...
	vuex: {
		getters: {
			...
			ascending: function ascending(state) {
				return state.inventory.ascending;
			},
			page: function page(state) {
				return state.inventory.page;
			},
			limit: function limit(state) {
				return state.inventory.limit;
			},
			expandedIndex: function expandedIndex(state) {
				return state.inventory.expandedIndex;
			}
		},
...
},{"../vuex/actions/inventory.js":73,"./addToCart.vue":46,"./pagination.vue":54,"./sortIcon.vue":55,"./statusIcon.vue":56,"babel-runtime/core-js/object/assign":1,"vue":43,"vue-hot-reload-api":17}],51:[function(require,module,exports){
'use strict';
...
},{"./addressBlock.vue":47,"./cartTable.vue":48,"./confirmedButton.vue":49,"./statusIcon.vue":56,"vue":43,"vue-hot-reload-api":17}],52:[function(require,module,exports){
'use strict';
...
},{"../vuex/actions/invoices.js":74,"./invoiceSummary.vue":51,"./pagination.vue":54,"./sortIcon.vue":55,"./statusIcon.vue":56,"babel-runtime/core-js/object/assign":1,"vue":43,"vue-hot-reload-api":17}],53:[function(require,module,exports){
"use strict";
...
},{"../vuex/actions/user.js":77,"./statusIcon.vue":56,"vue":43,"vue-hot-reload-api":17}],54:[function(require,module,exports){
"use strict";
...
},{"./app.vue":45,"./directives/mask.js":57,"./filters/displayFormat.js":58,"./filters/nl2br.js":59,"./pages/adminsettings.vue":61,"./pages/catalog.vue":62,"./pages/catalogs.vue":63,"./pages/inventory.vue":64,"./pages/invoice.vue":65,"./pages/invoices.vue":66,"./pages/item.vue":67,"./pages/newinvoice.vue":68,"./pages/pages.vue":69,"./pages/printinvoice.vue":70,"vue":43,"vue-resource":31,"vue-router":42,"vuex":44}],61:[function(require,module,exports){
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
},{"../components/inventoryTable.vue":50,"vue":43,"vue-hot-reload-api":17}],65:[function(require,module,exports){
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
},{"../components/invoicesTable.vue":52,"vue":43,"vue-hot-reload-api":17}],67:[function(require,module,exports){
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
},{"./actions/notificiations.js":75,"./actions/status.js":76,"./actions/user.js":77}],72:[function(require,module,exports){
'use strict';
...
var mutations = {
	UPDATE_ITEM_QUERY: function UPDATE_ITEM_QUERY(state, query) {
		state.query = query;
	},

	CHANGE_ITEM_PAGE: function CHANGE_ITEM_PAGE(state, page) {
		state.page = page;
	},

	EXPAND_ITEM_INDEX: function EXPAND_ITEM_INDEX(state, index) {
		state.expandedIndex = index;
	},

	SET_ITEM_SORT: function SET_ITEM_SORT(state, key) {
	...
	SET_ITEM_LIMIT: function SET_ITEM_LIMIT(state, limit) {
		state.limit = limit;
	}
};
...
},{"./modules/authentication.js":78,"./modules/cart.js":79,"./modules/inventory.js":80,"./modules/invoices.js":81,"./modules/notifications.js":82,"./modules/page.js":83,"./modules/status.js":84,"./modules/user.js":85,"vue":43,"vuex":44}]},{},[60]);
